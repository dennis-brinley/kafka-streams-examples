...
# PRIME THE SHELL ENVIRONMENT
source $DEMO_HOME/scripts/env.config

# CREATE TOPICS FROM LIST IF DNE
$DEMO_HOME/scripts/create-topics.sh $DEMO_HOME/scripts/topics.txt
